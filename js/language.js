...
(function () {
    ...
    var I18N = {
        ar: {
            ...
            selectOtpMethod: "حدد طريقة إرسال الرمز",
            whatsappLabel: "الواتس آب",
            emailLabel: "البريد الإلكتروني",
            otpRequestCount: "1/3 OTP عدد مرات طلب",
            sendCodeBtn: "إرسال الرمز",
            enterVerifyCode: "أدخل رمز التحقق",
            otpSentPrefix: "تم إرسال OTP إلى رقم هاتفك المسجل",
            otpInstructionPrefix: "أدخل الرمز المكون من 6 أرقام المرسل إلى",
            otpInstructionSuffix: "الكود صالح لمدة 5 دقائق ويمكن استخدامه مرة واحدة.",
            enterOtpLabel: "أدخل الـ OTP",
            resendOtp: "إعادة إرسال",
            otpVerifyCount: "عدد مرات طلب الـ OTP 1/3",
            paymentTitle: "سداد الاشتراك",
            payByCard: "الدفع بالبطاقة (من خلال باي موب)",
            visaMastercard: "فيزا / ماستركارد",
            serviceFeeCard: "تكلفة الخدمة 27 ج.م",
            payByFawry: "الدفع عن طريق فوري",
            fawryHint: "كود دفع يسدد خلال 72 ساعة من أي منفذ فوري",
            serviceFeeFawry: "تكلفة الخدمة 52 ج.م",
            fawryDetails: "سيتم إنشاء كود دفع فوري صالح لمدة 72 ساعة. يمكنك السداد من أي منفذ فوري أو تطبيق فوري.",
            paymentSummary: "ملخص الدفع",
            serviceFee: "تكلفة الخدمة",
            paymentTotal: "إجمالي المبلغ",
            cardNumber: "رقم البطاقة",
            cardHolder: "إسم حامل البطاقة",
            cardExpiry: "تاريخ الإنتهاء",
            cardCvv: "CVV",
            payBtn: "سداد",
            confirmTitle: "تأكيد العملية",
            paymentSuccessTitle: "تم سداد الاشتراك وتجديد العضوية بنجاح",
            paymentPendingTitle: "تسديد الإشتراك قيد الإنتظار",
            orderNumberLabel: "رقم الطلب",
            printReceipt: "طباعة الإيصال",
            renewNewMembership: "تجديد العضوية جديدة",
            backToHome: "الرجوع للشاشة الرئيسية",
            fawryPayBefore: "ادفع طلبك باستخدام كود فورى قبل يوم 20/8/2026",
            fawryCodeLabel: "كود فورى",
            copyFawryCode: "نسخ الكود",
        ...
        en: {
            ...
            stepPhoneConfirm: "Confirm phone",
            ...
            selectOtpMethod: "Select how to send the code",
            whatsappLabel: "WhatsApp",
            emailLabel: "Email",
            otpRequestCount: "OTP requests 1/3",
            sendCodeBtn: "Send code",
            enterVerifyCode: "Enter verification code",
            otpSentPrefix: "OTP has been sent to your registered phone number",
            otpInstructionPrefix: "Enter the 6-digit code sent to",
            otpInstructionSuffix: "The code is valid for 5 minutes and can be used once.",
            enterOtpLabel: "Enter OTP",
            resendOtp: "Resend",
            otpVerifyCount: "OTP requests 1/3",
            paymentTitle: "Subscription payment",
            payByCard: "Pay by card (via Paymob)",
            visaMastercard: "Visa / Mastercard",
            serviceFeeCard: "Service fee 27 EGP",
            payByFawry: "Pay via Fawry",
            fawryHint: "Payment code payable within 72 hours at any Fawry outlet",
            serviceFeeFawry: "Service fee 52 EGP",
            fawryDetails: "A Fawry payment code valid for 72 hours will be generated. You can pay at any Fawry outlet or app.",
            ...
            paymentSuccessTitle: "Subscription paid and membership renewed successfully",
            paymentPendingTitle: "Subscription payment is pending",
            orderNumberLabel: "Order number",
            printReceipt: "Print receipt",
            renewNewMembership: "Renew new membership",
            backToHome: "Return to main screen",
            fawryPayBefore: "Pay your order using the Fawry code before 20/8/2026",
            fawryCodeLabel: "Fawry code",
            copyFawryCode: "Copy code",
